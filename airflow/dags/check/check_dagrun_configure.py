...
class DagRunConfigOperator(BaseOperator):
    ...
    def execute(self, context):
        ...
        print("dir(dag_run):", dir(dag_run))
        print("dag_run.conf:", dag_run.conf)
        print("dag_run.get_task_instances():", dag_run.get_task_instances())
        print("conf:", conf.__dict__)

        #TODO: push configuration value
        import random
        self.update_conf("test_val", random.random(), context)
        return True

    def update_conf(self, key, value, context: dict):
        dag_run = context["dag_run"]
        dag_run.conf = {**dag_run.conf, key: value}
...
op_1 = DagRunConfigOperator(task_id="op-1")
op_2 = DagRunConfigOperator(task_id="op-2")
