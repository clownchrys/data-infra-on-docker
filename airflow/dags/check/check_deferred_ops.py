...
from operators.deferrable_op1 import TestAsyncOperator
# from operators.deferrable_op2 import TestAsyncOperator

def callback(context):
    ti = context["ti"]
    print("trigger: ", ti.trigger)
    print("trigger_id: ", ti.trigger_id)
...
dag = DAG(
    dag_id="check_deferred",
    description="deferred operator test",
...
deferred = TestAsyncOperator(task_id="training_job")

graph = start >> deferred >> end
